_G.LibLinq_1_0_Loader(function(LibLinq)
	...
	function Enumerable.From(obj)
		...
		elseif obj_type == 'userdata' and Enumerable.IsEnumerable(obj) then
			return obj
	...
	function Enumerable.RangeTo(start, finish, step)
		...
		if start < finish then
			return Enumerable.ToInfinity(start, step or 1):TakeWhile(function(i) return i <= finish end)
		else
			return Enumerable.ToNegativeInfinity(start, step or 1):TakeWhile(function(i) return i >= finish end)
		end
	end
